...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Thị Giang - Trường Tiểu học Vĩnh Thành - ĐT: 0913784075</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Thị Giang - Trường Tiểu học Vĩnh Thành - ĐT: 0913784075</div>", unsafe_allow_html=True)
